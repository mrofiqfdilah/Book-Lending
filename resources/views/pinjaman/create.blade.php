    ...
    <div class="card">
        ...
        <form action="{{ route('pinjaman.store') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-2">
                ...
                <input type="text" placeholder="Masukan Nama Peminjam" name="namapeminjam" class="form-control" id="namapeminjam">
            </div>

            <div class="mb-2">
                <label for="entitas" class="form-label">Jumlah Dipinjam</label>
                <input type="number" placeholder="Masukan Jumlah Buku Dipinjam" name="entitas" class="form-control" id="entitas">
            </div>
