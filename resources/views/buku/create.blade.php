    ...
    <div class="card">
        ...
        <form action="{{ route('buku.store') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-2">
                ...
                <input type="text" placeholder="Masukan Nama Buku" name="namabuku" class="form-control" id="namabuku">
            </div>

            <div class="mb-2">
                <label for="penerbit" class="form-label">Penerbit Buku</label>
                <input type="text" placeholder="Masukan Nama Penerbit" name="penerbit" class="form-control" id="penerbit">
            </div>

            <div class="mb-2">
                <label for="stock" class="form-label">Stock</label>
                <input type="number" placeholder="Masukan Jumlah Stock Buku" name="stock" class="form-control" id="stock">
            </div>
